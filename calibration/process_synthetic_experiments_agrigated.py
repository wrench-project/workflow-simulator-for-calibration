...
def process_experiment_sets(pickle_files, calibration, threshold1, threshold2):
	...
	for pickle_file in pickle_files:
		...
		for experiment in experiment_set.experiments:
			...
			label = f"{experiment_set.loss_function} {experiment_set.loss_aggregator}"
			to_plot[label]+=resl
	...
	plot_list=[]
	for key in to_plot:
		plot_list.append((to_plot[key],key))
		
	to_plot = sorted(plot_list)
	print(to_plot)
	...
	# Save the figure
	figure_name = "figure-synthetic-experiments-a.pdf"
