...
#TODO add way to make just 1 expiriment set containing arbitrary workflows, then calibrate on it
def parse_command_line_arguments(program_name: str):
    ...
    try:
        ...
        parser.add_argument('-al', '--algorithm', type=str,
                            ...
                            choices=['grid', 'random', 'gradient','skopt.gp','skopt.gbrt','skopt.rt','skopt.et'], required=True,
